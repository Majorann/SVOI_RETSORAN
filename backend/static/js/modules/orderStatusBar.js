const PHRASE_POOLS = {
  waiting: [
    ...
    "Удерживаем слот под ваш заказ",
    "Кухня уже знает о вашем визите",
    "Стартуем точно к нужному часу",
    "Синхронизируем подачу с бронью",
    "Ваш стол и заказ в расписании",
  ],
  cooking: [
    "Готовим ваш заказ",
    ...
    "Повар уже у плиты",
    "Скоро будет готово",
    "Кухня работает над вашим заказом",
    "Собираем подачу по блюдам",
    "Доводим заказ до готовности",
    "Горячее уже на подходе",
    "Команда кухни в процессе",
  ],
  delivering: [
    "Уже несём",
    "Заказ в пути",
    ...
    "Ваш заказ уже идёт",
    "Почти у вас",
    "Подача уже на выходе",
    "Несли аккуратно и быстро",
    "Ваш заказ уже выдали в зал",
    "Подходим к вашему столику",
    "Подача займёт ещё мгновение",
  ],
  delivered: [
    "Приятного аппетита!",
    "Заказ у вас",
  ...
  delivery_cooking: [
    ...
    "Готовим к отправке",
    "Упаковываем заказ для дороги",
    "Проверяем комплект перед отправкой",
    "Готовим блюда к выдаче курьеру",
    "Собираем доставку по позициям",
    "Финализируем заказ перед выездом",
  ],
  courier_sent: [
    "Курьер уже выехал",
    "Курьер в пути",
    ...
    "Курьер движется к адресу",
    "Заказ уже покинул ресторан",
    "Передача прошла, едем к вам",
    "Курьер забрал заказ без задержек",
  ],
  delivery_delivering: [
    "Курьер приближается",
    "Уже едем к вам",
    ...
    "Адрес уже рядом",
    "Курьер почти у двери",
    "Финальный отрезок пути",
    "Сейчас доставим",
  ],
  delivery_delivered: [
    "Заказ доставлен",
    ...
    "Заказ передан получателю",
    "Можно встречать доставку",
